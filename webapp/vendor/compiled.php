...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require 'C:\\xampp\\htdocs\\CleanWaterMapping\\vendor\\nesbot\\carbon\\src\\Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('event.name' => array('EventListener'), UserWasDeleted::class => array(DeleteUserGeneratedContent::class));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
